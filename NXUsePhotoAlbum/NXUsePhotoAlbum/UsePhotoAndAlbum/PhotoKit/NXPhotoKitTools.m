...
- (NSArray<NXPhotoAblumModel *> *)getAllUserAlbumList {
    NSMutableArray<NXPhotoAblumModel *> *photoAblumList = [NSMutableArray array];
    ...
    [userAlbums enumerateObjectsUsingBlock:^(PHAssetCollection * _Nonnull collection, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if (assets.count > 0) {
            NXPhotoAblumModel *ablum = [[NXPhotoAblumModel alloc] init];
            ablum.title = collection.localizedTitle;
            ablum.count = assets.count;
            ablum.posterImageAsset = assets.firstObject;
...
-(NSArray<NXPhotoAblumModel *> *)getAllAlbumList {
    ...
    NSMutableArray<NXPhotoAblumModel *> *photoAblumList = [NSMutableArray array];
    [photoAblumList addObjectsFromArray:[self getAllSmartAlbumList]];
    [photoAblumList addObjectsFromArray:[self getAllUserAlbumList]];
